...
class LFUCache(BaseCaching):
    """A caching system that uses the Least Frequentlu Used algorithm
    """
    ...
    def get(self, key):
        """ Retrieve the value in self.cache_data linked to key

        Args:
            key (str): The key associate with the item to be retrieved
